...
import BookstoreModel.BookstoreModel;
...
public class BookstoreTests {
	...
	public void beforeTest() {
		...
		graph = new MultiGraph(BookstoreTests.class.getSimpleName() + "_" + testName.getMethodName());
		graph.display(true);
	...
	public void afterTest() throws Exception {
		...
		pic.setAutofit(true);
		pic.writeAll(graph, "screenshots/" + BookstoreTests.class.getSimpleName() + "_graphstream_" + testName.getMethodName() + ".jpg");
	}
